...
oc new-app -f ./JavaProjects/openshift-templates/istio/istio_operator_template_origin.yaml

header_text "Installing istio components"
oc create -f ./JavaProjects/openshift-templates/istio/istio-installation.yaml -n istio-operator
